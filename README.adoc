...
| 1    | link:https://github.com/IUT-Blagnac/sae2023-2-02-November304/blob/main/simplicitepire.c[Pire c]| C     | Simplicité | Pire
| 2    | link:https://github.com/IUT-Blagnac/sae2023-2-02-November304/blob/main/src/main/java/exercice/efficacitepire.java[Pire java]    | Java     | Efficacité | Pire
| 3  | link:https://github.com/IUT-Blagnac/sae2023-2-02-November304/blob/main/src/main/java/exercice/simplicitemeilleur.java[Meilleur Java] | Java     | Simplicité | Meilleur     
|==========================================================================
...
- Java 17
- Compileur C qui compile tous les programmes en .c

=== Reproductibilité

- Pour reproduire nos analyses :
- En java : 
- Déplacer les fichiers Chrono.java et Memoire.java de analyse/ vers src/main/java et decommentez le code dans le main, vous verrez alors les temps d'execution de la classe Exercice pour trois tailles différente et la mémoire utilisée
. En C:
. En partant du principe que vous avez un compiler qui marche, déplacer test.c dans le même dossier que solution.c, et compiler tous les fichier .c ensemble
. Lancer le debugger -> Cela affichera les différentes phrases de test et le temps d'execution

=== Références

- link:https://app.codacy.com/organizations/gh/IUT-Blagnac/repositories[Codacy]
